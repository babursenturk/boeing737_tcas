...
;;
;;  DESCRIPTION: Seven Segment LCD user module for 22/24/27/29xxx PSoC family of devices.
;;
;; This set of functions is written to dirve from 1 to 8 seven segment displays.
;;
...
;;    PY.0 ==> Digit 1
;;    PY.1 ==> Digit 2
;;    PY.2 ==> Digit 3         Digit Number
;;    PY.3 ==> Digit 4        +---+---+---+---+---+---+---+---+
;;    PY.4 ==> Digit 5        | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 |
;;    PY.5 ==> Digit 6        +---+---+---+---+---+---+---+---+
;;    PY.6 ==> Digit 7
;;    PY.7 ==> Digit 8
;;
...
IF(1)                                            ; Active High Digit Drive
   and  [Port_0_Data_SHADE],~LED7SEG_1_DigitMask
ELSE                                             ; Active Low Digit Drive
...
.TRY_NEXT_DEC:                                   ; Completed last decade
   ...
   RAM_EPILOGUE RAM_USE_CLASS_2                  ; Restore system to class 2 memory mode
   pop   X
